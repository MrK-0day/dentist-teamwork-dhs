...
class recordNumberEditor extends React.Component<any, any> {
  constructor (props: any) {
    super(props)
    this.state = {
      value: props.node.data.recordNumber,
...
export default recordNumberEditor
