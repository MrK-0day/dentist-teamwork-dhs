...
export const EditMedialRecord = ({ props }: { props: any }) => {
  ...
  return (
    <Form layout='horizontal' style={{ width: '100%' }}>
      ...
      <Form.Item {...formItemLayout} label='Lần Khám'>
        <Input type='number' value={props.no} name='no' onChange={handleChange} placeholder='Lần Khám' />
      </Form.Item>
