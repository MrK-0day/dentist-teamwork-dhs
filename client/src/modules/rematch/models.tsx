...
import { GQL_getPatient, GQL_getPatientById, GQL_addPatient  ,GQL_removePatient, GQL_updatePatient, GQL_getRecords, GQL_addRecord, GQL_getSchedules, GQL_getDoctor, GQL_removeDoctor, GQL_addDoctor } from '../apollo/gql'
